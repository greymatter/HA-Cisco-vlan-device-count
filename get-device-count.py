"""Support for Cisco IOS switches."""
...
class CiscoDeviceScanner(DeviceScanner):
    ...
    def _get_arp_data(self):
        """Open connection to the switch and get mac addy table entries."""
        ...
        try:
            ...
            cisco_ssh.sendline("show mac address-table count")
            cisco_ssh.prompt(1)
...
## original code to parse out macs, this shit aint needed but i am keeping here for reference
...
def _parse_cisco_mac_table(cisco_mac_table):
    """Parse out the table and split up into VLAN totals
    e.g. convert
